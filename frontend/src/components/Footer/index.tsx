    ...
    <div className="ji gp">
      <div className="tc uf ap gg fp">
        <div className="animate_top zd/2 to/4">
          <a href="index.html">
            <img src="../../../public/images/tem/logo-light.svg" alt="Logo" className="om" />
          ...
          <ul className="tc wf cg">
            ...
            <li>
              <a href="#">
                <svg className="vh ul cl il" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
